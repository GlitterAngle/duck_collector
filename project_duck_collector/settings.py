"""
Django settings for project_duck_collector project.
...
SECRET_KEY = 'django-insecure-wmv!6vkcf_$_0xwbxfhjf#dr5ltqvqp1np+(xhzz&dv)@dh%wl'
...
ROOT_URLCONF = 'project_duck_collector.urls'
...
WSGI_APPLICATION = 'project_duck_collector.wsgi.application'


# Database
# https://docs.djangoproject.com/en/5.0/ref/settings/#databases
# comment this out so i can switch back to local 
# DATABASES = {
#     'default': {
